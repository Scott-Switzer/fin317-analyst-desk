...
-- All policies use DO-block guards to avoid DROP POLICY.
-- REVOKE is used only for defense-in-depth — it is idempotent and
--   does not destroy data or schema.
--
-- If policies with these names already exist, this file will skip
-- creating them (no error). If you need to REPLACE existing policies,
-- use supabase/dashboard_safe_demo_setup.sql (which uses DROP POLICY IF EXISTS
-- and will trigger the Supabase "destructive operations" warning).
--
...
-- ============================================================================
-- RLS POLICIES — Nondestructive first-time setup
-- Uses DO blocks to check if policy exists before creating.
-- This avoids DROP POLICY (which triggers Supabase "destructive" warning).
-- ============================================================================
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'anon_read_missions' AND tablename = 'missions') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'anon_read_mission_versions' AND tablename = 'mission_versions') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'anon_read_badges' AND tablename = 'badges') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'auth_read_own_profile' AND tablename = 'profiles') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'auth_update_own_profile' AND tablename = 'profiles') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'auth_read_classes' AND tablename = 'classes') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'auth_read_class_memberships' AND tablename = 'class_memberships') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'auth_read_own_submissions' AND tablename = 'submissions') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'auth_insert_own_submissions' AND tablename = 'submissions') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'auth_read_own_calc_results' AND tablename = 'calculation_results') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'auth_read_own_ai_feedback' AND tablename = 'ai_feedback') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'auth_read_own_progress' AND tablename = 'student_progress') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'auth_insert_own_progress' AND tablename = 'student_progress') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'auth_update_own_progress' AND tablename = 'student_progress') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'auth_read_own_badges' AND tablename = 'student_badges') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'prof_read_own_class_analytics' AND tablename = 'class_analytics') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'auth_read_own_events' AND tablename = 'event_log') THEN
...
-- REVOKE is idempotent — revoking privileges that don't exist is a no-op.
-- This does NOT destroy data or schema. It is pure access control.
-- ============================================================================
